    ...
    <div className="w-full bg-white shadow-md sticky top-0  ">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <button
          ...
          className="lg:hidden fixed bottom-6 right-6 z-50 p-4 bg-primary hover:bg-secondary text-white rounded-full shadow-2xl transition-all duration-300 transform hover:scale-110"
            ...
            {topMenuItems.map((item) => (
              ...
              >
                ...
                {item.hasDropdown && activeMenu === item.name && (
                  <div className="absolute right-0 left-0 top-full pt-2 z-50 min-w-max ">
